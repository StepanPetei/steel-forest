...
var slideShow = function () {
  return function (selector, config) {
    var _slider = document.querySelector(selector),
      ...
      delayAutoplay: 5000,
      isPauseOnHover: true
    }; // setting up slider config depend of received keys
    ...
    } // variable with methods, returning max and min value of number of slides and current number
    ...
    }; // installing listeners for actions
    ...
    _addIndicators(); // setting up listeners


    _setUpListeners(); // deploy autoplay


    _startAutoplay();

    return {
      // turning the next slide
      next: function next() {
        _move("next");
      },
      // turning the prev slide
      left: function left() {
        _move("prev");
      },
      // tufn off autoplay
